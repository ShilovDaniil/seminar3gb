...
При слиянии двух веток может создаваться конфликт, если текст или код написаны на одной строке. Git отображает оба варианта и пользователь может выбрать наиболее подходящий для него.